 ...
 */
function createWebviewMessageHandler({ openBrowser, retry, interaction = undefined, threadResult = undefined }) {
  ...
  return (message) => {
    ...
    if (message.type === 'dshThreadAttachResult' && typeof threadResult === 'function') {
